...
class StringsTest(unittest.TestCase):
    ...
    def test_contains_with_non_matching_patterns(self):
        ...
        assert contains('flippydo', 'alan') is False
        assert contains('trump', 'drump') is False
    ...
    def test_contains_with_complex_patterns(self):
        ...
        assert contains('mississippi', 'iss') is True
        assert contains('chipchipchipipy', 'ip') is True
    ...
    def test_find_index_with_matching_patterns(self):
        ...
        assert find_index('aabbc', 'bbc') == 2
        assert find_index('abbada', 'bad') == 2
    ...
    def test_find_index_with_non_matching_patterns(self):
        ...
        assert find_index('flippydo', 'alan') is None
        assert find_index('trump', 'drump') is None
    ...
    def test_find_index_with_complex_patterns(self):
        ...
        assert find_index('mississippi', 'iss') == 1
        assert find_index('chipchipchipipy', 'ip') == 2
    ...
    def test_find_all_indexes_with_matching_patterns(self):
        ...
        assert find_all_indexes('aabbc', 'bbc') == [2]
        assert find_all_indexes('abbada', 'bad') == [2]
    ...
    def test_find_all_indexes_with_non_matching_patterns(self):
        ...
        assert find_all_indexes('flippydo', 'alan') == []
        assert find_all_indexes('trump', 'drump') == []
    ...
    def test_find_all_indexes_with_complex_patterns(self):
        ...
        assert find_all_indexes('chipchipchipipy', 'ip') == [2, 6, 10, 12]
